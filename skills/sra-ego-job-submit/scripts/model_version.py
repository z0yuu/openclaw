...
用法：工作目录为 skill 根目录时 python scripts/model_version.py <子命令> ...
"""
import json
import sys
...
def main() -> None:
    ...
    p_list.add_argument("--create_time_start", type=int, default=None, help="毫秒")
    p_list.add_argument("--create_time_end", type=int, default=None, help="毫秒")
    ...
    p_create.add_argument("body", type=str, help="JSON 请求体(含 version_name, entry_file_name, code_file)")
