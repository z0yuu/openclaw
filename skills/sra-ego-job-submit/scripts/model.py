...
用法：工作目录为 skill 根目录时 python scripts/model.py <子命令> ...
"""
import json
import sys
...
def main() -> None:
    ...
    p_list.add_argument("--create_time_start", type=int, default=None, help="创建时间起始(秒)")
    p_list.add_argument("--create_time_end", type=int, default=None, help="创建时间结束(秒)")
    ...
    p_create.add_argument("--auth_users", type=str, default=None, help="逗号分隔邮箱")
